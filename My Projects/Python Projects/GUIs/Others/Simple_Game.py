...
if __name__ == "__main__":
    ...
    def help():
        ...
        Label(help_window, text='Rules', bg='black', fg='white', font=('Bookman Old Style', 24, 'underline', 'italic')).place(relx=0.3, rely=0.04)
        Label(help_window, text="1. rock vs rock >>> Tie", bg='black', fg='white', font=('Bookman Old Style', 16, 'italic')).place(relx=0.05, rely=0.2)
        Label(help_window, text="2. rock vs paper >>> paper", bg='black', fg='white', font=('Bookman Old Style', 16, 'italic')).place(relx=0.05, rely=0.27)
        Label(help_window, text="3. rock vs scissors >>> rock", bg='black', fg='white', font=('Bookman Old Style', 16, 'italic')).place(relx=0.05, rely=0.34)
        Label(help_window, text="4. paper vs rock >>> paper", bg='black', fg='white', font=('Bookman Old Style', 16, 'italic')).place(relx=0.05, rely=0.41)
        Label(help_window, text="5. paper vs paper >>> Tie", bg='black', fg='white', font=('Bookman Old Style', 16, 'italic')).place(relx=0.05, rely=0.48)
        Label(help_window, text="6. paper vs scissors >>> scissors", bg='black', fg='white', font=('Bookman Old Style', 16, 'italic')).place(relx=0.05, rely=0.55)
        Label(help_window, text="7. scissors vs rock >>> rock", bg='black', fg='white', font=('Bookman Old Style', 16, 'italic')).place(relx=0.05, rely=0.62)
        Label(help_window, text="8. scissors vs paper >>> scissors", bg='black', fg='white', font=('Bookman Old Style', 16, 'italic')).place(relx=0.05, rely=0.69)
        Label(help_window, text="9. scissors vs scissors >>> Tie", bg='black', fg='white', font=('Bookman Old Style', 16, 'italic')).place(relx=0.05, rely=0.76)
